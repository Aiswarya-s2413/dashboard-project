...
def analyze_cooldown_impact_104():
    # We'll fix the holding period to 104 weeks
    holding_weeks = 104
    cooldown_options = [20, 26, 40, 52, 60, 78, 104]
    
    print(f"Impact of Cooldown on 104-Week Holding Period Performance\n")
