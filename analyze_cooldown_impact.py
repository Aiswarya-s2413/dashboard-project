...
def analyze_cooldown_impact():
    # We'll fix the holding period to 52 weeks (the "sweet spot") and vary the cooldown
    holding_weeks = 52
    cooldown_options = [20, 26, 40, 52, 60, 78, 90, 104]
    
    print(f"Impact of Cooldown on 52-Week Holding Period Performance\n")
